...
class DecoderLayer(tf.keras.layers.Layer):
    def __init__(
        ...
        d_ffwd, r_kernel, seed=1234, causal=True, 
        ...
        self.attn_self = MultiHeadAttention(
            d_model, n_heads, r_kernel, 
            seed=seed, causal=causal, name=name)
...
class GPTPerformer(tf.keras.Model):
    def __init__(
        ...
        vocab_size, max_seq_length, seed=1234, 
        rate1=0.1, rate2=0.1, r_kernel=None, causal=True):
        ...
        self.gpt_model = Decoder(
            ...
            max_seq_length, seed=seed, rate1=rate1, 
