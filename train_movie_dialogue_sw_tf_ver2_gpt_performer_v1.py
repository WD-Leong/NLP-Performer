...
import tf_ver2_performer_v1 as gpt
        ...
        for n_win in range(n_windows):
            ...
            with tf.GradientTape() as grad_tape:
                output_tuple  = model(
                    ...
                    k_prev=k_prev, kv_prev=kv_prev, training=True)
                
                k_prev  = output_tuple[0]
                kv_prev = output_tuple[1]
...
model_ckpt_dir  = "TF_Models/dialogue_sw_gpt_performer_v1"
train_loss_file = "train_loss_dialogue_sw_gpt_performer_v1.csv"
...
gpt_model = gpt.GPTPerformer(
    num_layers, num_heads, hidden_size, 
    ffwd_size, vocab_size, seq_length, seed=seed, 
    rate1=0.0, rate2=p_drop, r_kernel=dim_kernel)
...
print("-" * 50)
print("Training the GPT Performer Network", 
...
while n_iter < maximum_iter:
    ...
    if n_iter % display_step == 0:
        ...
        print("Gradient Clip:", str(grad_clip) + ".")
