...
import tf_ver2_performer as gpt
...
model_ckpt_dir  = "TF_Models/dialogue_subword_gpt_performer"
train_loss_file = "train_loss_dialogue_subword_gpt_performer.csv"
...
gpt_model = gpt.GPTPerformer(
    ...
    seq_length, rate1=0.0, rate2=p_drop, 
    seed=seed, r_kernel=dim_kernel, causal=True)
...
print("-" * 50)
print("Training the Performer Network", 
